...
total = pak_bp_s1 + pak_bp_s2 + pak_level + pak_bp_s3 + pak_bp_s4 + pak_quest_s5 + pak_quest_s6 + pak_bp_s5 + pak_bp_s6
...
print("*assuming you finished all 6 battlepasses,are level 500 and you did not buy any other packs")
print(" ")
