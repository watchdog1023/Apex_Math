...
total = pak_bp_s1 + pak_bp_s2 + pak_level + pak_bp_s3 + pak_bp_s4 + pak_quest_s5 + pak_quest_s6 + pak_bp_s5 + pak_bp_s6 + pak_quest_s7 + pak_bp_s7 + pak_quest_s8 + pak_bp_s8 + pak_bp_s9 + pak_quest_s9 + pak_bp_s10 + pak_quest_s10 + pak_arenas
...
print("*assuming you finished all 10 battlepasses,are level 500,finished all 5 quests and you did not buy any other packs")
print(" ")
